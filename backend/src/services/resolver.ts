...
async function askAI(
  ...
  const systemPrompt = `You are the resolution oracle for a prediction market platform called LaunchMarket. Your job is to determine whether a prediction market question has resolved YES, NO, or should be VOIDED.
