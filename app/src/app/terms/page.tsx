    ...
    <div className="max-w-3xl mx-auto space-y-6">
      ...
      <section className="space-y-3">
        ...
        <p className="text-degen-muted text-sm leading-relaxed">
          DegenBets is a decentralized prediction market platform built on the Solana blockchain. Users can create markets on real-world events, buy and sell outcome shares, and earn returns based on correct predictions. DegenBets does not provide financial advice and is not a licensed financial service.
        </p>
      </section>
      ...
      <section className="space-y-3">
        ...
        <p className="text-degen-muted text-sm leading-relaxed">
          You must be of legal age in your jurisdiction to use this platform. You are responsible for ensuring that your use of DegenBets complies with all applicable laws and regulations in your jurisdiction. Prediction markets may be restricted or prohibited in certain regions.
        </p>
      </section>
      ...
      <section className="space-y-3">
        ...
        <p className="text-degen-muted text-sm leading-relaxed">
          You are solely responsible for the security of your wallet and private keys. DegenBets does not custody your funds at any time &mdash; all transactions occur directly on the Solana blockchain. You acknowledge that you may lose some or all of the funds you commit to prediction markets.
        </p>
      </section>
      ...
      <section className="space-y-3">
        ...
        <p className="text-degen-muted text-sm leading-relaxed">
          DegenBets is provided &ldquo;as is&rdquo; without warranties of any kind. The platform operators shall not be liable for any losses resulting from smart contract bugs, incorrect market resolutions, blockchain network issues, or any other cause. Your use of the platform is entirely at your own risk.
        </p>
      </section>
