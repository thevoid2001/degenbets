    ...
    <div className="max-w-3xl mx-auto space-y-6">
      ...
      <section className="space-y-3">
        ...
        <p className="text-degen-muted text-sm leading-relaxed">
          DegenBets is a decentralized application that prioritizes user privacy. We do not require account creation, email addresses, or any personal identifying information. All interaction with the platform is wallet-based.
        </p>
      </section>
